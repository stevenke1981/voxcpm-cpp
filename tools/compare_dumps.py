...
def main():
    ...
    step_pairs = [
        ...
        ("dump_lm_hidden_ar_",    ["lm_hidden_fsq"],          0),
        ("dump_residual_hidden_ar_", ["residual_hidden_step"], 0),
        ("dump_fe_output_update_", ["curr_embed_raw"],         -prompt_len),
        ("dump_audio_embed_update_", ["curr_embed_proj"],      -prompt_len),
        ("dump_base_hidden_update_", ["lm_hidden_step"],       -prompt_len),
        ("dump_lm_hidden_step_",  ["lm_hidden_fsq"],          -prompt_len),
